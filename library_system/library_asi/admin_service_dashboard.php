...
?>
            ...
            <p style="color:black;text-align:left;margin-left:200px;"><u>Book Name:</u> &nbsp&nbsp<?php echo $bookname ?></p>
            <p style="color:black;text-align:left;margin-left:200px;"><u>Book Detail:</u> &nbsp&nbsp<?php echo $bookdetail ?></p>
            <p style="color:black;text-align:left;margin-left:200px;"><u>Book Authour:</u> &nbsp&nbsp<?php echo $bookauthour ?></p>
            <p style="color:black;text-align:left;margin-left:200px;"><u>Book Publisher:</u> &nbsp&nbsp<?php echo $bookpub ?></p>
            <p style="color:black;text-align:left;margin-left:200px;"><u>Book Branch:</u> &nbsp&nbsp<?php echo $branch ?></p>
            <p style="color:black;text-align:left;margin-left:200px;"><u>Book Price:</u> &nbsp&nbsp<?php echo $bookprice ?></p>
            <p style="color:black;text-align:left;margin-left:200px;"><u>Book Available:</u> &nbsp&nbsp<?php echo $bookava ?></p>
            <p style="color:black;text-align:left;margin-left:200px;padding-bottom:20px"><u>Book Rent:</u> &nbsp&nbsp<?php echo $bookrent ?></p>
